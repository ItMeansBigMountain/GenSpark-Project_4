...
public class Goblin extends Humanoid {
    ...
    public Goblin(Random random, int[] coordinates) {
        ...
        this.attack = random.ints(5, 9).findFirst().getAsInt();
        this.strength = random.ints(5, 9).findFirst().getAsInt();
    ...
    public Goblin(int attack, int strength, int defence, int intelligence, int health, int compassion, int[] coordinates, int combatLVL) {
        this.attack = attack;
